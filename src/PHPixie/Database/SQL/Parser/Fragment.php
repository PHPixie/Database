...
abstract class Fragment
{
    ...
    {
        if (is_object($column) && $column instanceof \PHPixie\Database\SQL\Expression)
    ...
    public function appendTable($table, $expr, $alias = null)
    {
        ...
        } elseif ( ($isQuery = $table instanceof \PHPixie\Database\SQL\Query) || $table instanceof \PHPixie\Database\SQL\Expression) {
    ...
    {
        if ($value instanceof \PHPixie\Database\SQL\Expression) {
            $expr->append($value);
