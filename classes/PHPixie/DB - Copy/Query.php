...
abstract class Query
{
	...
	protected $joins;
	protected $having;
	protected $builder_map = array(
		'where'        => array('conditions', 'where'),
		'or_where'     => array('conditions', 'or_where'),
		'start_where'  => array('conditions', 'start_group'),
		'end_where'    => array('conditions', 'end_group'),
		
		'having'       => array('having', 'where'),
		'or_having'    => array('having', 'or_where'),
		'start_having' => array('having', 'start_group'),
		'end_having'   => array('having', 'end_group'),
	);
	...
	public function __call($method, $args)
	{
		...
		if (in_array($method, $this->builder_map)) {
			list($builder, $method) = $this->builder_map[$method];
			return call_user_func_array(array($this->$builder, $method), $args);
		}
