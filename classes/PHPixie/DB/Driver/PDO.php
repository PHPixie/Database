...
class PDO extends \PHPixie\DB\Driver
{
    ...
    {
        $class = '\PHPixie\DB\Driver\PDO\\'.$adapterName.'\Parser';
    ...
    {
        $class = '\PHPixie\DB\Driver\PDO\\'.$adapterName.'\Parser\Fragment';
    ...
    {
        $class = '\PHPixie\DB\Driver\PDO\\'.$adapterName.'\Parser\Operator';
    ...
    {
        $class = '\PHPixie\DB\Driver\PDO\\'.$adapterName.'\Parser\Group';
