...
namespace PHPixie\Tests\Database\Driver\Mongo\Parser\Conditions;

/**
 * @coversDefaultClass \PHPixie\Database\Driver\Mongo\Parser\Conditions\ExpandedGroup
 */
class ExpandedGroupTest extends \PHPixie\Tests\Database\Conditions\Condition\ImplementationTest
{
    /**
     * @covers ::negate
     * @covers ::isNegated
