 ...
 */
class OperatorTest extends \PHPixie\Tests\AbstractDatabaseTest
{
    protected $parser;
    ...
    {
        $this->assertDatabaseException('exists', array('test'), '_id');
    ...
    {
        $this->assertDatabaseException('between', 6);
        $this->assertDatabaseException('between', array(6));
        $this->assertDatabaseException('between', 'in', 7);
        $this->assertDatabaseException('between', 'in', array(6),7);
    }

    protected function assertDatabaseException($operator, $value, $field = 'p', $convertMongoId = true)
    {
        $except = false;
