...
namespace PHPixie\Tests\Database\Type\SQL\Query\Implementation;

/**
 * @coversDefaultClass \PHPixie\Database\Type\SQL\Query\Implementation\Builder
 */
abstract class BuilderTest extends \PHPixie\Tests\Database\Query\Implementation\BuilderTest
{
    ...
    public function testAddOnCondition()
    {
        ...
        $this->assertDatabaseException(function() use($builder, $condition) {
