<?php
namespace PHPixieTests\Database\Driver\PDO\Adapter\Sqlite;

/**
 * @coversDefaultClass \PHPixie\Database\Driver\PDO\Adapter\Sqlite\Parser
 */
class ParserTest extends \PHPixieTests\Database\Driver\PDO\ParserTest
{
    ...
    {
        $queries = parent::exceptionQueries();
