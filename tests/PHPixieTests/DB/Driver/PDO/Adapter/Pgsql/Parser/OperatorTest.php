...
/**
 * @coversDefaultClass \PHPixie\DB\Driver\PDO\Adapter\Pgsql\Parser\Operator
 */
class OperatorTest extends \PHPixieTests\DB\SQL\Parser\OperatorTest
{
    ...
    {
        parent::setUp();
        $fragment = $this->db->driver('PDO')->fragmentParser('Pgsql');
        $this->operatorParser = $this->db->driver('PDO')->operatorParser('Pgsql', $fragment);
    }
}
