...
abstract class ResultTest extends PHPUnit_Framework_TestCase {
	...
	public function testGetColumn() {
		$this->assertEquals(array('Tinkerbell', null, 'Trixie'), $this->result->get_column('name'));
	}
	
	public function testGetColumnNulls() {
		$this->assertEquals(array('Tinkerbell',  'Trixie'), $this->result->get_column('name', true));
	}
