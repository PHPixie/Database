...
class ParserTest extends PHPUnit_Framework_TestCase {
	...
	protected function setUp(){
		...
		$group_parser = new \PHPixie\DB\Driver\Mongo\Parser\Group($driver, $operator_parser);
		$this->parser = new \PHPixie\DB\Driver\Mongo\Parser($this->pixie, $driver, 'default', $group_parser);
	}
	...
	protected function assertException($query) {
		$except = false;
		try {
			$chain = $this->parser->parse($query)->get_chain();
