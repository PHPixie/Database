...
class SqliteOperatorTest extends SQLOperatorTest {
	...
	public function setUp() {
		parent::setUp();
		$fragment = $this->db->driver('PDO')->fragment_parser('Sqlite');
		$this->operator_parser = $this->db->driver('PDO')->operator_parser('Sqlite', $fragment);
	}
}