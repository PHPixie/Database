...
class PgsqlOperatorTest extends SQLOperatorTest {
	...
	public function setUp() {
		parent::setUp();
		$fragment = $this->db->driver('PDO')->fragment_parser('Pgsql');
		$this->operator_parser = $this->db->driver('PDO')->operator_parser('Pgsql', $fragment);
	}
}