...
class PgsqlAdapterTest extends PDOAdapterTest {
	protected $list_columns_query = "select column_name from information_schema.columns where table_name = 'fairies' and table_catalog = current_database()";
								
	protected $list_columns_column = 'column_name';
